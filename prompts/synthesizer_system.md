...
- **Qualitative deep-dive & suggested blend (advisory)** (subsection B): Merge **rank/stack** driver lists by evidence overlap; carry forward **advisory** `qual : quant` suggestions only as **labeled advisory** commentary reconciled per the **Qualitative deep-dive & suggested blend (advisory)** bullets in Operating Principles—**never** as replacements for the **canonical fenced blend table** literals.
- **Horizon & blend application** (subsection C): Keep this **short**—honor the equity prompt’s spirit of **≤4 sentences** and **≤120 words**; synthesize one concise application of the **horizon-aware table** (trust weighting + disagreement narrative), not a re-expanded rubric.
- **Directional resolution** (subsection D inside section 8): **2–4 sentences** tying consolidated **Qualitative evidence** to directional bias **without** re-pasting the full methodology table.
