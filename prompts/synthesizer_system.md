...
- **Horizon & blend application** (subsection B): Keep this **short**—honor the equity prompt’s spirit of **≤4 sentences** and **≤120 words**; synthesize one concise application of the **horizon-aware table** (trust weighting + disagreement narrative), not a re-expanded rubric.
